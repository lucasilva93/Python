...
print(f"La persona è: {PersonaA.nome}, cognome: {PersonaA.cognome} ")
...
depositato = Conto_Bancario(5000,3400)
prelevato = Conto_Bancario(3000,2200)
...
prodotto1 = Prodotto("Lavatrice", 400, 5)
prodotto2 = Prodotto("Lavastovigle", 350, 10)
prodotto3 = Prodotto("Aspirapolvere", 200, 0)
pr1 = prodotto1.totale()
pr2 = prodotto2.totale()
pr3 = prodotto3.verifica_qtà()
pr4 = prodotto3.totale()
print(f"Il costo totale delle lavastoviglie è: {pr1}")
print(f"Il costo totale delle lavatrici è: {pr2}")
if pr3 is not None: 
     print(f"Il costo totale delle lavatrici è: {pr3}")
if pr3 is not None:
